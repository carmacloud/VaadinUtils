...
public class DoubleRangeValidator extends RangeValidator<Double> {
    ...
    public DoubleRangeValidator(Class<Double> type, String parseErrorMessage, String rangeErrorMessage, Double minValue,
            Double maxValue, Boolean minInclusive, Boolean maxInclusive) {

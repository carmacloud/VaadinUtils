...
public class TwinColumnSearchableSelect<C extends CrudEntity> extends CustomField<Collection<C>> {
    ...
    /**
     * Unfortunately TwinColumnSelect wont work with large sets, it isn't searchable
     * and it doesn't lazy load, it also isn't sortable.
     *
    ...
    public TwinColumnSearchableSelect(final String fieldName, final SingularAttribute<C, ?> listField,
        ...
        availableContainer.sort(new Object[] { listField.getName() }, new boolean[] { isAscending });
    ...
    protected void setInternalValue(Collection<C> newValue) {
        ...
        beans.sort(new Object[] { listField.getName() }, new boolean[] { isAscending });

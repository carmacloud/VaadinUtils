...
public class MenuBuilder implements Serializable {
    ...
    /**
     * 
     * @param topLevelMenuOrder - specify the order of the top level menus
     * @return
     */
    ...
    /**
     * Searches for a parement menu item. If it doesn't exist it will be created.
     * 
     * @param parentItem
     * @param menuName
     * @param currentPath
    ...
    // currentPath)
    {
        ...
        if (currentItem == null) {
            currentItem = parentItem.addItem(displayName, null);
            /*
             * , new MenuBar.Command() { private static final long serialVersionUID = 1L;
             * 

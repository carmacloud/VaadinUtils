...
public interface WizardProgressListener {
    ...
    /**
     * Called when collection {@link WizardStep}s is changed (i.e. a step is added
     * or removed) and this {@code WizardProgressListener} is expected to update
     * itself accordingly.
     * 
     ...
     * 
     * @param event {@link WizardCompletedEvent} object containing details about the
     *              event
     */
     ...
     * 
     * @param event {@link WizardCancelledEvent} object containing details about the
     *              event
     */

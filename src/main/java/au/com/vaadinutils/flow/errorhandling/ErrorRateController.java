...
public class ErrorRateController {
    ...
    private final LinkedBlockingQueue<Boolean> availablePermits = new LinkedBlockingQueue<>();

    private final Stopwatch lastCreated = Stopwatch.createStarted();
    ...
    /**
     * 
     * @param maxBurst        - maximum of permits that will be stockpiled for a
     *                        burst after a period of less or activity
     * @param permitRate      - rate at which permits become available per
     *                        permitRateUnits
    ...
    /**
     * returns true if able to acquire a permit, more specifically true if the rate

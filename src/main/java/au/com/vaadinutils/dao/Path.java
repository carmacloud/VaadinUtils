...
public class Path {
    ...
    /**
     * Invalidates any cached entities of the classes within the SingularAttributes.
     * The first class is ignored as this is the parent, which should be dealt with
     * elsewhere
     * 
     * @return the Path
     */
    ...
    /**
     * Adds a transient field to the Path. This method can only be called once on a
     * Path.
     *

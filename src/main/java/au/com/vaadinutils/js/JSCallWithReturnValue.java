...
public class JSCallWithReturnValue {
    ...
    /**
     * 
     * @param jsToExecute - the actual JS you want to execute and get a return value
     *                    for like... new Date(); <br>
     *                    <br>
     *                    JavaScriptCallback <Boolean> callback = new
     *                    JavaScriptCallback <Boolean>()<br>
     *                    {<br>
     * 
